...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .on_menu_event(|event| match event.menu_item_id() {
            ...
            "locale_cz" | "locale_en" | "locale_fr" | "locale_ge" | "locale_hu" | "locale_it" | "locale_jp" | "locale_kr" | "locale_pl" | "locale_po" | "locale_sk" | "locale_es" | "locale_es-mx" | "locale_tu" | "locale_ru" | "locale_ro" => {
                let window = event.window();
                ...
                std::thread::spawn(move || {
                    ...
                    menu_handle.get_item("locale_ro").set_selected(false).expect("Can't find menu item for locale_ro");
